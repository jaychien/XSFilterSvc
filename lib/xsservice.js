...
var XSService = function(server) {
                ...
                /*
                    ...
                    [
                     { "Names": [{"Names":["股號"]},
                        ...
                        "Desc":null,
                        "ScriptTypes":[1,4,5,6],
                        "Freqs":[8,9,10,11,12,13,14,15,16,999]
                     },
                    ]
                ...
                */
                ...
                _.each(fields, function(field) {
                    if (field.Freqs && field.Freqs.length > 0 && field.Names && field.Names.length > 0) {
                        ...
                        var chName = field.Names[0].Names[0];
                        //console.log(chName);
                        ...
                        if (!uniqueMap[field.Id]) {
                            ...
                            var aliases = [];
                            for (var i in field.Names) {
                                aliases.push(field.Names[i].Names[0]);
                            }                            
    ...
    function parseHistData(doc, fields, count) {
        ...
        */
        ...
        dataList.push(returnFields);    // 第一筆放欄位名稱
        ...
        /*
            var dataList2 = [];
            dataList2.push(returnFields);   // 第一筆放欄位名稱
    ...
    function composeHistDataRequestXml(symbolID, freq, fields, count) {
        ...
        */
        ...
        xml = xml + sprintf("<Symbol ID='%s' Freq='%d' Fields='%s' Limit='%d' Order='desc'/>", symbolID, freq, getFieldList(fields), count);
        return xml;
    }
