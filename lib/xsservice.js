...
var XSService = function(options) {
    ...
    var XSRequest = function() {
        ...
        //
        this.sendRequst = function(url, version, actionCode, postXml, cb) {
                    ...
                    if (encoding == 'gzip') {
                        zlib.gunzip(buffer, function(err, decoded) {
                            if (err != null) {
                                ...
                                parseResult(decoded && decoded.toString(), cb);
                            }
                        });
                        ...
                        parseResult(buffer.toString(), cb);
                    }
                });
            });
    ...
    this.getHistData_v2 = function(symbolID, freq, fields, count, cb) {
        ...
        xsrequest.sendRequst(this.options.server + url, version, actionCode, postXml, function(err, doc) {
            if (err != null) {
                cb(err);
            }
            else {
